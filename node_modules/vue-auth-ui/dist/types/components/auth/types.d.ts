...
export declare type View = 'sign_in' | 'sign_up' | 'magic_link' | 'forgotten_password' | 'update_password';
export declare type Provider = 'google' | 'facebook' | 'twitter' | 'apple' | 'github' | 'gitlab' | 'bitbucket' | 'discord' | 'azure' | 'keycloak' | 'linkedin' | 'notion' | 'slack' | 'spotify' | 'twitch' | 'workos';
